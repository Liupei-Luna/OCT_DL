# -*- coding: utf-8 -*-
"""
Created on Fri May 10 16:36:02 2019
...
for dirname in lists: 
    IMAGES_PATH = 'F:/fingerprint/3D_Fingerprint_1-2/number1/third_Dirty/'+dirname+'/'  # 图片集地址
    IMAGES_FORMAT = ['.bmp']  # 图片格式
    IMAGE_SIZE = 256  # 每张小图片的大小
    IMAGE_ROW = 20  # 图片间隔，也就是合并成一张图后，一共有几行
    IMAGE_COLUMN = 20  # 图片间隔，也就是合并成一张图后，一共有几列
    IMAGE_SAVE_PATH = 'F:/fingerprint/3D_Fingerprint_1-2/number10/third_Dirty/'+dirname+'.bmp'  # 图片转换后的地址
    # 获取图片集地址下的所有图片名称
